...
export default function BrowseRoom() {
  return (
    <section className="flex bg-gray-100 py-16 px-4 md:px-10 lg:px-16" id="browse-the-room">
        <div className="container mx-auto">
            ...
            <div className="grid grid-rows-2 grid-cols-9 gap-4">
                ...
                >
                    ...
                    <div
                    className="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-40 lg:pl-72"
                    >
