...
export default function Hero() {
  return (
    <section className="flex items-center hero">
      <div className="w-full text-white md:text-black absolute z-20 inset-0 md:relative md:w-1/2 text-center flex flex-col justify-center hero-caption">
        ...
        <div>
          <a
            ...
            className="bg-pink-400 text-black cursor-pointer hover:bg-black hover:text-pink-400 rounded-full px-8 py-3 mt-4 inline-block flex-none transition duration-200"
          >
            Explore Now
          </a>
        </div>
        ...
        <div className="relative hero-image">
          ...
          <div className="overlay right-0 bottom-0 md:inset-0">
            <button
              ...
              data-content='<div class="w-full pb-56 md:pb-72 relative z-50">
